...
int main(void)
{
  ...
  while (1)
  {
    ...
    //   printf("sw8 opening...\n");
    // }
    static GPIO_PinState last_state = HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_7);
    while(HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_7) != last_state)
    {
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins output : PF0123 8 */
